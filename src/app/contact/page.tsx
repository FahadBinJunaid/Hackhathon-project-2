      ...
      <div className="max-w-[1440px] mx-auto px-32 py-12 mt-6">
            <div className="grid sm:grid-cols-2 items-start gap-14 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
                <div>
                    ...
                    <div className="mt-12">
                        ...
                        <ul className="mt-4">
                            <li className="flex items-center">
                                <div className="bg-[#2A254B] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                ...
                                <a href="javascript:void(0)" className="text-[#2A254B] text-sm ml-4">
                    ...
                    <div className="mt-12">
                        ...
                        <ul className="flex mt-4 space-x-4">
                            <li className="bg-[#2A254B] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                ...
                <form className="ml-auo space-y-4">
                    ...
                    <button type='button'
                        className="text-white bg-[#2A254B] hover:bg-blue-600 rounded-md text-sm px-4 py-3 w-full !mt-6">Send</button>
                </form>
            </div>
        </div>
        <Footer />
